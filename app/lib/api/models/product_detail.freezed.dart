...
@JsonKey(name: 'variant_total') Price? get variantTotal; List<ProductSpec> get specs; List<DescriptionBlock> get description; ProductAvailability? get availability; ProductRating get rating; List<ProductReview> get reviews; List<Product> get similar; List<Benefit> get benefits;
...
int get hashCode {
  final _this = this as ProductDetail;
  return Object.hashAll([runtimeType,_this.id,_this.variantId,_this.name,_this.defaultCode,_this.badge,const DeepCollectionEquality().hash(_this.images),_this.price,_this.clubPrice,const DeepCollectionEquality().hash(_this.priceTables),_this.variants,const DeepCollectionEquality().hash(_this.variantRows),_this.variantTotal,const DeepCollectionEquality().hash(_this.specs),const DeepCollectionEquality().hash(_this.description),_this.availability,_this.rating,const DeepCollectionEquality().hash(_this.reviews),const DeepCollectionEquality().hash(_this.similar),const DeepCollectionEquality().hash(_this.benefits)]);
}

@override
String toString() {
  final _this = this as ProductDetail;
  return 'ProductDetail(id: ${_this.id}, variantId: ${_this.variantId}, name: ${_this.name}, defaultCode: ${_this.defaultCode}, badge: ${_this.badge}, images: ${_this.images}, price: ${_this.price}, clubPrice: ${_this.clubPrice}, priceTables: ${_this.priceTables}, variants: ${_this.variants}, variantRows: ${_this.variantRows}, variantTotal: ${_this.variantTotal}, specs: ${_this.specs}, description: ${_this.description}, availability: ${_this.availability}, rating: ${_this.rating}, reviews: ${_this.reviews}, similar: ${_this.similar}, benefits: ${_this.benefits})';
}
...
/// Create a copy of ProductDetail
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? variantId = freezed,Object? name = null,Object? defaultCode = freezed,Object? badge = freezed,Object? images = null,Object? price = null,Object? clubPrice = freezed,Object? priceTables = null,Object? variants = freezed,Object? variantRows = null,Object? variantTotal = freezed,Object? specs = null,Object? description = null,Object? availability = freezed,Object? rating = null,Object? reviews = null,Object? similar = null,Object? benefits = null,}) {
