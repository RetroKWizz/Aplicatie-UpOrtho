...
int get hashCode {
  final _this = this as ProductDetail;
  return Object.hash(runtimeType,_this.id,_this.variantId,_this.name,_this.defaultCode,_this.badge,const DeepCollectionEquality().hash(_this.images),_this.price,_this.clubPrice,const DeepCollectionEquality().hash(_this.tiers),const DeepCollectionEquality().hash(_this.clubTiers),_this.variants,const DeepCollectionEquality().hash(_this.specs),const DeepCollectionEquality().hash(_this.description),_this.availability,_this.rating,const DeepCollectionEquality().hash(_this.reviews),const DeepCollectionEquality().hash(_this.similar),const DeepCollectionEquality().hash(_this.benefits));
}

@override
String toString() {
  final _this = this as ProductDetail;
  return 'ProductDetail(id: ${_this.id}, variantId: ${_this.variantId}, name: ${_this.name}, defaultCode: ${_this.defaultCode}, badge: ${_this.badge}, images: ${_this.images}, price: ${_this.price}, clubPrice: ${_this.clubPrice}, tiers: ${_this.tiers}, clubTiers: ${_this.clubTiers}, variants: ${_this.variants}, specs: ${_this.specs}, description: ${_this.description}, availability: ${_this.availability}, rating: ${_this.rating}, reviews: ${_this.reviews}, similar: ${_this.similar}, benefits: ${_this.benefits})';
}
...
@useResult
$Res call({
 int id,@JsonKey(name: 'variant_id') int? variantId, String name,@JsonKey(name: 'default_code') String? defaultCode, ProductBadge? badge, List<ProductImage> images, Price price,@JsonKey(name: 'club_price') Price? clubPrice, List<PriceTier> tiers,@JsonKey(name: 'club_tiers') List<PriceTier> clubTiers, VariantOptions? variants, List<ProductSpec> specs, List<DescriptionBlock> description, ProductAvailability? availability, ProductRating rating, List<ProductReview> reviews, List<Product> similar, List<Benefit> benefits
});
...
/// Create a copy of ProductDetail
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? variantId = freezed,Object? name = null,Object? defaultCode = freezed,Object? badge = freezed,Object? images = null,Object? price = null,Object? clubPrice = freezed,Object? tiers = null,Object? clubTiers = null,Object? variants = freezed,Object? specs = null,Object? description = null,Object? availability = freezed,Object? rating = null,Object? reviews = null,Object? similar = null,Object? benefits = null,}) {
...
as Price?,tiers: null == tiers ? _self.tiers : tiers // ignore: cast_nullable_to_non_nullable
as List<PriceTier>,clubTiers: null == clubTiers ? _self.clubTiers : clubTiers // ignore: cast_nullable_to_non_nullable
as List<PriceTier>,variants: freezed == variants ? _self.variants : variants // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _ProductDetail() when $default != null:
return $default(_that.id,_that.variantId,_that.name,_that.defaultCode,_that.badge,_that.images,_that.price,_that.clubPrice,_that.tiers,_that.clubTiers,_that.variants,_that.specs,_that.description,_that.availability,_that.rating,_that.reviews,_that.similar,_that.benefits);case _:
  return orElse();
...
class _ProductDetail implements ProductDetail {
  const _ProductDetail({required this.id, @JsonKey(name: 'variant_id') this.variantId, required this.name, @JsonKey(name: 'default_code') this.defaultCode, this.badge,  List<ProductImage> images = const [], required this.price, @JsonKey(name: 'club_price') this.clubPrice,  List<PriceTier> tiers = const [], @JsonKey(name: 'club_tiers')  List<PriceTier> clubTiers = const [], this.variants,  List<ProductSpec> specs = const [],  List<DescriptionBlock> description = const [], this.availability, this.rating = const ProductRating(),  List<ProductReview> reviews = const [],  List<Product> similar = const [],  List<Benefit> benefits = const []}): _images = images,_tiers = tiers,_clubTiers = clubTiers,_specs = specs,_description = description,_reviews = reviews,_similar = similar,_benefits = benefits;
...
@override@JsonKey() List<PriceTier> get tiers {
  if (_tiers is EqualUnmodifiableListView) return _tiers;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_tiers);
}

 final  List<PriceTier> _clubTiers;
@override@JsonKey(name: 'club_tiers') List<PriceTier> get clubTiers {
  if (_clubTiers is EqualUnmodifiableListView) return _clubTiers;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_clubTiers);
}
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _ProductDetail&&(identical(other.id, id) || other.id == id)&&(identical(other.variantId, variantId) || other.variantId == variantId)&&(identical(other.name, name) || other.name == name)&&(identical(other.defaultCode, defaultCode) || other.defaultCode == defaultCode)&&(identical(other.badge, badge) || other.badge == badge)&&const DeepCollectionEquality().equals(other.images, _images)&&(identical(other.price, price) || other.price == price)&&(identical(other.clubPrice, clubPrice) || other.clubPrice == clubPrice)&&const DeepCollectionEquality().equals(other.tiers, _tiers)&&const DeepCollectionEquality().equals(other.clubTiers, _clubTiers)&&(identical(other.variants, variants) || other.variants == variants)&&const DeepCollectionEquality().equals(other.specs, _specs)&&const DeepCollectionEquality().equals(other.description, _description)&&(identical(other.availability, availability) || other.availability == availability)&&(identical(other.rating, rating) || other.rating == rating)&&const DeepCollectionEquality().equals(other.reviews, _reviews)&&const DeepCollectionEquality().equals(other.similar, _similar)&&const DeepCollectionEquality().equals(other.benefits, _benefits));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode {
    return Object.hash(runtimeType,id,variantId,name,defaultCode,badge,const DeepCollectionEquality().hash(_images),price,clubPrice,const DeepCollectionEquality().hash(_tiers),const DeepCollectionEquality().hash(_clubTiers),variants,const DeepCollectionEquality().hash(_specs),const DeepCollectionEquality().hash(_description),availability,rating,const DeepCollectionEquality().hash(_reviews),const DeepCollectionEquality().hash(_similar),const DeepCollectionEquality().hash(_benefits));
}

@override
String toString() {
    return 'ProductDetail(id: $id, variantId: $variantId, name: $name, defaultCode: $defaultCode, badge: $badge, images: $images, price: $price, clubPrice: $clubPrice, tiers: $tiers, clubTiers: $clubTiers, variants: $variants, specs: $specs, description: $description, availability: $availability, rating: $rating, reviews: $reviews, similar: $similar, benefits: $benefits)';
}
...
as List<ProductImage>,price: null == price ? _self.price : price // ignore: cast_nullable_to_non_nullable
as Price,clubPrice: freezed == clubPrice ? _self.clubPrice : clubPrice // ignore: cast_nullable_to_non_nullable
as Price?,tiers: null == tiers ? _self._tiers : tiers // ignore: cast_nullable_to_non_nullable
as List<PriceTier>,clubTiers: null == clubTiers ? _self._clubTiers : clubTiers // ignore: cast_nullable_to_non_nullable
as List<PriceTier>,variants: freezed == variants ? _self.variants : variants // ignore: cast_nullable_to_non_nullable
